-- =============================================================================
-- REPAIR PHASE 4: Reconstruct timecard links for 2024
-- =============================================================================
-- Same logic as Phase 3 but for year 2024, split into quarters.
-- Run each quarter separately to keep queries fast.
--
...
-- =============================================
-- Set the quarter you are running (change these two dates per run):
--   Q1: '2024-01-01' to '2024-03-31'
--   Q2: '2024-04-01' to '2024-06-30'
--   Q3: '2024-07-01' to '2024-09-30'
--   Q4: '2024-10-01' to '2024-12-31'
-- =============================================
...
-- ─────────────────────────────────────────────────────────────────────────────
-- STEP 5: CLEANUP — then change @start_date / @end_date for next quarter
-- ─────────────────────────────────────────────────────────────────────────────
DROP TEMPORARY TABLE IF EXISTS tmp_tc_mapping;
